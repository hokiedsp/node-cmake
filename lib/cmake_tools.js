    ...
    await new Promise(function (resolve, reject) {
      ...
      fs.exists(cmake_path, function (exists) {
        if (!exists) {
          ...
          // bat_file.write('  set PATH_BAK=%PATH%\n');
          // bat_file.write('  set PATH=\n');
          // bat_file.write('  set path=\n');
          // bat_file.write('  call where /Q ninja\n');
          // bat_file.write('  if ERRORLEVEL 1 (\n');
          // bat_file.write('    set Path = %PATH_BAK%\n');
          // bat_file.write('  )\n');
          // bat_file.write('  set PATH_BAK=\n');
        ...
        else // file already exists, no need to re-create
        {
          resolve();
        }
      });
